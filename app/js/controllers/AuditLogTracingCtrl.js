assetHealthApp.controller('AuditLogTracingCtrl',['$scope', '$filter', '$http', 'UserData', 'ServiceLocations', function($scope, $filter, $http, userData, serviceLocations){
...
//	$scope.downloadMessageContents= function(id) {
//		$scope.auditLogId = id;
//		var auditLogDownloadUrl = '/ah-detector-registration-ui/main/secure/transaction/auditLogEntry/download?uid=' + id;
//		$scope.auditLogDownloadUrl = '/ah-detector-registration-ui/main/secure/transaction/auditLogEntry/download?uid=' + id;
//		$scope.fullMessage = 'fetching...';
//		$http.get(auditLogDownloadUrl)
//		.success(function(data){
////			$scope.fullMessage = data;  
//		})
//		.error(function(input){
//			$scope.fullMessage = 'failed to obtain transaction data';
//		});	
//	};
	...
	$scope.getResults = function() {
		...
		var fetchUrl = serviceLocations.detectorServicesBase+'main/secure/transactionContexts/' + params;
...
//	var filterValuesUrl = '/ah-detector-registration-ui/main/secure/transaction/filterValues';
